...
import { getSellerCustomerReport } from "@/lib/seller/reports"
...
export const metadata = { title: "Seller — Customer Reports" }

interface Props {
  searchParams: Promise<{ from?: string; to?: string }>
}

export default async function SellerCustomerReportsPage({ searchParams }: Props) {
  ...
  const report = await getSellerCustomerReport(shop.id, from, to)
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-border-default overflow-hidden">
        <div className="flex items-center justify-between p-5 pb-0">
          ...
          <a
            href={`/api/seller/reports/export?type=customers&${exportQuery}`}
